...
-- Fly (non-randomized unlocks): town visited => reach town region or an unlock-source sub-region.
Entry_point:connect_one_way(REGION_CHERRYGROVE_CITY, "Fly to Cherrygrove City", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_CHERRYGROVE_CITY"), reach("REGION_CHERRYGROVE_CITY:FLOODED_MINE_ENTRANCE"))
    end)
end)
Entry_point:connect_one_way(REGION_AZALEA_TOWN, "Fly to Azalea Town", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_AZALEA_TOWN"), reach("REGION_AZALEA_TOWN:WELL"))
    end)
end)
Entry_point:connect_one_way(REGION_ECRUTEAK_CITY, "Fly to Ecruteak City", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_ECRUTEAK_CITY"), reach("REGION_ECRUTEAK_CITY:TIN_TOWER_TRAIL"))
    end)
end)
Entry_point:connect_one_way(REGION_MAHOGANY_TOWN, "Fly to Mahogany Town", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_MAHOGANY_TOWN"), reach("REGION_MAHOGANY_TOWN:EAST"))
    end)
end)
Entry_point:connect_one_way(REGION_LAKE_OF_RAGE, "Fly to Lake of Rage", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_LAKE_OF_RAGE"), reach("REGION_LAKE_OF_RAGE:HIDDEN_POWER_HOUSE"))
    end)
end)
Entry_point:connect_one_way(REGION_BLACKTHORN_CITY, "Fly to Blackthorn City", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_BLACKTHORN_CITY"), reach("REGION_BLACKTHORN_CITY:DRAGONS_DEN_ENTRANCE"))
    end)
end)
Entry_point:connect_one_way(REGION_VERMILION_CITY, "Fly to Vermilion City", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_VERMILION_CITY"), reach("REGION_VERMILION_CITY:GYM_ENTRANCE"),
            reach("REGION_VERMILION_CITY:DIGLETTS_CAVE_ENTRANCE"), reach("REGION_ROUTE_11"))
    end)
end)
Entry_point:connect_one_way(REGION_CELADON_CITY, "Fly to Celadon City", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_CELADON_CITY"), reach("REGION_CELADON_CITY:GYM_ENTRANCE"))
    end)
end)
Entry_point:connect_one_way(REGION_FUCHSIA_CITY, "Fly to Fuchsia City", function()
    return ALL(can_fly, "randomize_fly_unlocks_false", function()
        return ANY(reach("REGION_FUCHSIA_CITY"), reach("REGION_FUCHSIA_CITY:CUT"))
    end)
end)
...
REGION_TIN_TOWER_1F:connect_one_way_entrance(NAMED_NODES["REGION_ECRUTEAK_CITY:TIN_TOWER_TRAIL"], "dungeon")
